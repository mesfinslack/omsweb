...
$sql1= "SELECT * FROM admin where  username = '$data->username' ";
$sql11= "SELECT * FROM admin where  username = '$data->username'  and id = '$data->id' ";
$sql2= "SELECT * FROM admin where  email = '$data->email'   ";
$sql22= "SELECT * FROM admin where  email = '$data->email' and id = '$data->id'";
$sql5= "SELECT * FROM admin where  phone = '$data->phone' ";
$sql55= "SELECT * FROM admin where  phone = '$data->phone'  and id = '$data->id' ";
...
if($error){
	...
	$UPDATE = "UPDATE admin set fname='$data->fname',lname='$data->lname',sex='$data->sex', username='$data->username',phone='$data->phone',phone2='$data->phone2',role='$data->role',email='$data->email',region='$data->region',zone='$data->zone',town='$data->town' where id =$data->id";


		$insertqry = $conn->query($UPDATE);
		if($insertqry){

		$selectsql = "SELECT * from admin  WHERE username ='$data->username' and id = '$data->id'";
