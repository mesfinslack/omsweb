...
$sql11= "SELECT * FROM agencies where  username = '$data->username' and id = $data->id";
$sql2= "SELECT * FROM agencies where  email = '$data->email' ";
$sql22= "SELECT * FROM agencies where  email = '$data->email' and  id = $data->id";
$sql5= "SELECT * FROM agencies where  phone = '$data->phone' ";
$sql55= "SELECT * FROM agencies where  phone = '$data->phone' and id = $data->id";
...
if($error){
	...
	$UPDATE = "UPDATE agencies set name='$data->name',fax='$data->fax',website='$data->website', username='$data->username',phone='$data->phone',phone2='$data->phone2',license='$data->license',email='$data->email',region='$data->region',zone='$data->zone',town='$data->town' where id ='$data->id'";


		$insertqry = $conn->query($UPDATE);
		if($insertqry){

		$selectsql = "SELECT * from agencies  WHERE username ='$data->username' and id = '$data->id'";
